...
```
🔭 Atualmente aprofundando:   Data Science aplicada e arquiteturas Full Stack escaláveis
...
## 🏆 Liderança & Destaques em Hackathons

### 🌎 Latinaton — Hackathon Internacional (Brasil · Colômbia · México)
**Front-End Team Leader**
Liderança da arquitetura de interfaces, prototipagem e desenvolvimento em um ecossistema Full Stack (**Django + React/TypeScript**), em parceria institucional com **IFMG**, **CEPEDI** e **Softex** — coordenando um time multidisciplinar em um evento de alcance internacional.

### 🚀 Infinity School Hackathon
**Backend Team Leader**
Estruturação de regras de negócio, modelagem de dados e desenvolvimento de APIs, liderando as decisões técnicas do backend sob pressão de tempo típica de ambientes de hackathon.
...
<details open>
<summary><b>⚙️ Back-End & APIs</b></summary>
<br>

![Django](https://img.shields.io/badge/Django-092E20?style=for-the-badge&logo=django&logoColor=white)
![Django REST Framework](https://img.shields.io/badge/Django_REST_Framework-ff1709?style=for-the-badge&logo=django&logoColor=white&labelColor=333333)
![Node.js](https://img.shields.io/badge/Node.js-339933?style=for-the-badge&logo=nodedotjs&logoColor=white)
![Flet](https://img.shields.io/badge/Flet-1DE9B6?style=for-the-badge&logoColor=white)

</details>

<details open>
<summary><b>📊 Data Science, IA & Analytics</b></summary>
<br>
...
![ETL & SSIS](https://img.shields.io/badge/ETL_%26_SSIS-CC2927?style=for-the-badge&logo=microsoftsqlserver&logoColor=white)
![Transfer Learning](https://img.shields.io/badge/Transfer_Learning_MobileNet-FF6F00?style=for-the-badge&logo=tensorflow&logoColor=white)
...
<details open>
<summary><b>🔌 IoT, Testes & Infraestrutura</b></summary>
<br>
...
<details open>
<summary><b>🎯 UI/UX & Versionamento</b></summary>
<br>
...
### 🌎 Plataforma de Gestão de Hackathons — *Latinaton / Projeto_IFMG*
Ecossistema Full Stack completo (**Django + React/TypeScript/Tailwind**) para gerenciamento de eventos internacionais: inscrições, equipes e submissões de projetos. Desenvolvido como Front-End Team Leader em parceria com IFMG, CEPEDI e Softex.
...
### 🐱🐶 Classificação de Imagens com Transfer Learning — *Cat_x_Dog*
Modelo de Deep Learning aplicando **Redes Neurais Convolucionais (CNN)** com **Transfer Learning (MobileNet)** para otimizar o treinamento e classificar imagens com alta eficiência computacional.
...
### 📈 Análise de Dados com Python & Data Science
Projeto de tratamento, limpeza e análise exploratória de dados (EDA) com **Pandas** e **NumPy**, culminando em relatórios automatizados para apoio à tomada de decisão.
...
### 🔧 Projetos de IoT e Automação — *Extensão Anhanguera*
Aplicações com sensores e microcontroladores integrando hardware e software em ambiente simulado, unindo lógica de programação a dispositivos físicos inteligentes.
...
- Full Stack Developer, Data Science e Transfer Learning — *Infinity School*
- Análise em Python — *Universidade Anhanguera*
- Manutenção de Computadores — *F5 Informática*
- IoT e Dispositivos Inteligentes / Sensores, Microcontroladores e Programação em IoT — *Anhanguera*
- Teste e Inspeção de Software: técnicas e automatização — *Anhanguera*
...
![Inglês](https://img.shields.io/badge/Inglês-Intermediário-1565C0?style=for-the-badge)
![Espanhol](https://img.shields.io/badge/Espanhol-Intermediário-AA151B?style=for-the-badge)
